...
outflag = input("Would you like to save the results in a csv file (miLEA_out.csv in the same path as input file) -- Yes?")
dict_map = pickle.load(infile)
infile.close()
...
zipped = list(zip(dis,odds,pval,qvalues))
j= len(zipped)
